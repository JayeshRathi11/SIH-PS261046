...
* **Core Bottleneck**:
  * CDSCO ke New Drugs and Clinical Trials (NDCT) Rules 2019 ke tehat Serious Adverse Event (SAE) ΓÇö jaise patient hospitalization, life-threatening toxicity, ya death ΓÇö ko 24 hours ke strict statutory window me report karna mandatory hai[cite: 2].
...
| **DPDP Act 2023 & 2025 Rules**[cite: 1, 2] | Purpose limitation, data minimization, granular consent lifecycle, sensitive personal health data protection[cite: 1, 2]. | Field-level PII encryption at rest + Multilingual consent receipts + Automated withdrawal purge cascades[cite: 1, 2]. | Penalties up to Γé╣250 Crores enforced by Data Protection Board of India[cite: 2]. |
...
|  Γö£ΓöÇΓöÇ Doctor / PI Portal           Γö£ΓöÇΓöÇ Study Coordinator Desk     Γö£ΓöÇΓöÇ Ethics Committee (IEC) Desk  |
|  Γö£ΓöÇΓöÇ NPvCC Safety Desk            Γö£ΓöÇΓöÇ DSMB / Executive Board     ΓööΓöÇΓöÇ CDSCO Auditor Read-Only Desk |
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
Γöé  Γû▓
HTTPS (REST / JSON Schemas)     Γöé  Γöé  WebSockets (Real-time SLA Countdown & Toasts)
Γû╝  Γöé
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
|                                  2. APPLICATION BACKEND CORE                                      |
|  FastAPI (Python 3.11+) + Pydantic v2 Engine + SQLAlchemy 2.0 (Async)                             |
|  Γö£ΓöÇΓöÇ Dynamic JSON-Schema Form Engine (Prakriti, Agni & Lab Vitals)                                |
|  Γö£ΓöÇΓöÇ State Machine Controller (Draft -> IEC Approved -> CTRI Linked -> Active -> Closed)         |
|  Γö£ΓöÇΓöÇ Atomic SAE Escalator & Deterministic 24-Hour Regulatory SLA Engine                           |
|  Γö£ΓöÇΓöÇ Cryptographic ALCOA+ Audit Interceptor (Pre-Persist SHA-256 Chainer)                        |
|  Γö£ΓöÇΓöÇ Distributed Lock Manager (Redis SETNX) & Idempotency Key Validator                           |
|  ΓööΓöÇΓöÇ CDISC SDTM & HL7 FHIR R4 Transformation Pipeline                                            |
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
Γöé                                                  Γöé
Async Event Stream Γöé (Postgres LISTEN/NOTIFY / Redis Queue)           Γöé Raw SQL Transactions (ACID)
Γû╝                                                  Γû╝
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+  +ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
|        3. LOCAL ASYNCHRONOUS SAFETY WORKER    |  |               4. PERSISTENCE LAYER             |
|  Standalone Python Worker / Celery            |  |  PostgreSQL 16 + pgvector                      |
|  Γö£ΓöÇΓöÇ MedDRA Coding Engine (SIDER 4.1 Lookup)  |  |  Γö£ΓöÇΓöÇ Relational Schema (Multi-Tenant Trials)   |
|  Γö£ΓöÇΓöÇ Ayurvedic Herb-Drug Conflict Checker     |  |  Γö£ΓöÇΓöÇ Dynamic eCRF Store (JSONB with GIN Index) |
|  Γö£ΓöÇΓöÇ Semantic Search (@xenova/transformers)   |  |  Γö£ΓöÇΓöÇ alcoa_audit_ledger (INSERT-Only Chained)  |
|  Γö£ΓöÇΓöÇ Dead-Letter Retry Queue (Upstash QStash) |  |  Γö£ΓöÇΓöÇ access_audit_logs (DPDP Access Audit)   |
|  ΓööΓöÇΓöÇ Form CT-16 Headless PDF Generator        |  |  ΓööΓöÇΓöÇ Redis 7 (Heartbeats, Locks, KPI Cache)    |
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+  +ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
Γöé
Periodic Merkle Root ExportΓöé (Isolated Out-of-Band Channel)
Γû╝
...
|  ΓööΓöÇΓöÇ Immutable Merkle Root Notarization Ledger |
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
```
[cite: 2]
...
[Clinical Client UI]
Γöé
Γöé 1. POST /api/patients/{id}/adverse-event (Payload: Clinical notes, Severity)
Γû╝
[FastAPI Route Guard]
Γöé
Γöé 2. Validate JWT Claims & Context (Site ID, Protocol Assignment, DPDP Consent State)
Γû╝
[Postgres ACID Transaction]
Γöé
Γöé 3. Acquire Pessimistic Lock: SELECT ... FOR UPDATE on target patient record
Γöé 4. Evaluate Severity: If 'Hospitalization'/'Death'/'Life-Threatening' -> Flag is_serious = TRUE
Γöé 5. Trigger Synchronous 24h Regulatory SLA Clock (Immediate persistent DB timestamp)
Γû╝
[ALCOA+ Audit Interceptor (Pre-Persist Hook)]
Γöé
Γöé 6. Extract JSONDelta (old values vs new values)
Γöé 7. Fetch Previous Record Hash from alcoa_audit_ledger
Γöé 8. Compute CurrentHash = SHA256(PrevHash + EntityID + JSONDelta + UserID + Timestamp)
Γöé 9. INSERT into alcoa_audit_ledger (Atomic execution within transaction boundary)
Γû╝
[Postgres Transaction Commit]
Γöé
Γöé 10. Release Pessimistic Lock; Commit changes to core tables and audit ledger
Γöé 11. Emit Postgres NOTIFY event: 'ae_event_stream' with event payload
Γû╝
[Decoupled Event Bus] ΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé (Immediate Broadcast)                                  Γöé (Async Queue)
Γû╝                                                        Γû╝
[WebSocket Gateway Service]                            [Local Safety Worker]
Γöé                                                        Γöé
Γöé 12. Push 24-hr SLA Countdown Clock                     Γöé 13. SIDER 4.1 Lookup -> MedDRA PT Code
Γöé     to PI, IEC & Safety Dashboards                     Γöé 14. Herb-Drug Conflict Check
Γû╝                                                        Γöé 15. Compile Form CT-16 PDF
[Client Browser UI]                                                Γû╝
...
* **The "Before" Scenario**: Study complete hone ke baad clinical research organization (CRO) ne SDTM conversion ke liye Γé╣15 Lakhs aur 4 mahine ka quote diya. Publication deadline miss ho gayi.
...
+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ+
...
### Phase 1: Foundation & Monorepo Workspace Scaffolding (Hours 0 ΓÇô 6)
...
### Phase 2: Database Initialization, Migrations & Dataset Ingestion (Hours 6 ΓÇô 12)
...
### Phase 3: Core API & Decoupled State Machine (Hours 12 ΓÇô 20)
...
### Phase 4: ALCOA+ Cryptographic Ledger & Merkle Notary (Hours 20 ΓÇô 26)
...
### Phase 5: Frontend Dashboard & Offline-First eCRF (Hours 26 ΓÇô 34)
...
### Phase 6: Pharmacovigilance & Regulatory Automation (Hours 34 ΓÇô 40)
...
### Phase 7: Interoperability Pipelines & CDISC/FHIR Exporters (Hours 40 ΓÇô 48)
...
Γö£ΓöÇΓöÇ apps/
Γöé   Γö£ΓöÇΓöÇ api/                           # FastAPI Application Core
Γöé   Γöé   Γö£ΓöÇΓöÇ Dockerfile
Γöé   Γöé   Γö£ΓöÇΓöÇ requirements.txt
Γöé   Γöé   Γö£ΓöÇΓöÇ main.py
Γöé   Γöé   Γö£ΓöÇΓöÇ core/                      # Config, Database Session, Security
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ config.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ database.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ security.py
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ rls.py
Γöé   Γöé   Γö£ΓöÇΓöÇ models/                    # SQLAlchemy Core & Audit Models[cite: 2]
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ trial.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ patient.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ ecrf.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ adverse_event.py
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ audit_ledger.py
Γöé   Γöé   Γö£ΓöÇΓöÇ routers/                   # REST API Endpoints[cite: 2]
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ trials.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ patients.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ ecrf.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ safety.py
Γöé   Γöé   Γöé   Γö£ΓöÇΓöÇ audit.py
Γöé   Γöé   Γöé   ΓööΓöÇΓöÇ export.py
Γöé   Γöé   ΓööΓöÇΓöÇ services/                  # Business Logic Engines[cite: 2]
Γöé   Γöé       Γö£ΓöÇΓöÇ alcoa_interceptor.py
Γöé   Γöé       Γö£ΓöÇΓöÇ sla_engine.py
Γöé   Γöé       Γö£ΓöÇΓöÇ cdisc_exporter.py
Γöé   Γöé       ΓööΓöÇΓöÇ fhir_exporter.py
Γöé   ΓööΓöÇΓöÇ web/                           # Next.js 14 Frontend Portal[cite: 2]
Γöé       Γö£ΓöÇΓöÇ Dockerfile
Γöé       Γö£ΓöÇΓöÇ package.json
Γöé       Γö£ΓöÇΓöÇ tailwind.config.ts
Γöé       Γö£ΓöÇΓöÇ src/
Γöé       Γöé   Γö£ΓöÇΓöÇ app/                   # App Router (Role-based portals)[cite: 2]
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ layout.tsx
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ page.tsx
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ doctor/
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ coordinator/
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ ethics/
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ safety-npvcc/
Γöé       Γöé   Γöé   ΓööΓöÇΓöÇ auditor/
Γöé       Γöé   Γö£ΓöÇΓöÇ components/            # Reusable UI Components[cite: 2]
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ ClinicalTable.tsx
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ DynamicECRF.tsx
Γöé       Γöé   Γöé   Γö£ΓöÇΓöÇ CountdownClock.tsx
Γöé       Γöé   Γöé   ΓööΓöÇΓöÇ HerbDrugAlertModal.tsx
Γöé       Γöé   ΓööΓöÇΓöÇ lib/                   # RxDB, API Client, Utils
Γöé       Γöé       Γö£ΓöÇΓöÇ rxdb.ts
Γöé       Γöé       ΓööΓöÇΓöÇ api.ts
Γö£ΓöÇΓöÇ workers/
Γöé   ΓööΓöÇΓöÇ safety_engine/                 # Background Safety & NLP Workers[cite: 2]
Γöé       Γö£ΓöÇΓöÇ Dockerfile
Γöé       Γö£ΓöÇΓöÇ worker.py
Γöé       Γö£ΓöÇΓöÇ sae_watchdog.py
Γöé       ΓööΓöÇΓöÇ herb_matrix.json
ΓööΓöÇΓöÇ scripts/
    Γö£ΓöÇΓöÇ init_db.sql                    # Full PostgreSQL DDL & RLS Policies[cite: 2]
    Γö£ΓöÇΓöÇ ingest_sider_meddra.py         # SIDER TSV to Postgres Importer[cite: 2]
    ΓööΓöÇΓöÇ generate_synthetic_data.py     # 100+ Patient Cohort Generator
[cite: 2]
```
...
2. **Review & Medical Reconciliation Phase (Hours 1 ΓÇô 6)**: Pharmacovigilance officer auto-coded MedDRA Preferred Terms review karta hai. Herb-Drug conflict alerts evaluate hote hain (e.g., Guduchi-Warfarin potentiation). Baseline vitals aur causality assessment form me verify kiye jate hain.
3. **Institutional Escalation Phase (Hours 6 ΓÇô 12)**: System $T-12\text{h}$ warning status par automated alert push karta hai. Principal Investigator pre-filled Form CT-16 review karke cryptographic digital signature authenticate karta hai. IEC Secretariat report digitally acknowledge karta hai.
4. **Statutory Submission Phase (Hours 12 ΓÇô 20)**: Fully validated, digitally signed Form CT-16 PDF export hoti hai. Official preliminary notification CDSCO licensing authority (SUGAM Portal) aur Institutional Ethics Committee ko securely transmit hoti hai within statutory 24 hours[cite: 2].
5. **Detailed Follow-up Phase (Day 2 ΓÇô Day 14)**: Follow-up clinical investigations aur medical management details capture hoti hain. NDCT Rules 2019 ke mandate ke mutabiq detailed causality report 14 calendar days ke andar submit hoti hai[cite: 2].
